...
class _ZenitWindowButtonPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    final Paint foregroundPaint = Paint()
      ...
      //hopefully set that 1.0 when flutter fixes their rendering...
      ..strokeWidth = 1;
    ...
    if (hover) {
      canvas.drawCircle(center, 12, hoverPaint);
    }
...
void drawRestoreMaximize(Canvas canvas, bool maximized, Rect buttonRect, Paint foregroundPaint, Color foregroundColor) {
  const gap = 2;
